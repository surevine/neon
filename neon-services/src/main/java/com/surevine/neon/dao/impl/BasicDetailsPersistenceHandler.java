...
public class BasicDetailsPersistenceHandler extends AbstractNamespaceHandler {
    ...
    public void persist(ProfileBean profile, DataImporter importer) {
        ...
        if(profile.getVcard().getJid() != null) {
        	setSingleField(hsetKey, FIELD_JID, importer.getImporterName(), profile.getVcard().getJid());
        }
    }
    ...
    public void load(ProfileBean profile) {
        if (profile.getUserID() != null) {
            ...
            profile.getVcard().setJid(getSingleField(profileData, FIELD_JID, profile));
