...
public class GitlabProfileImporter extends AbstractDataImporter implements DataImporter {
	...
	private String profileBaseURL="http://10.66.2.254/api/v3/users?private_token={auth_token}&per_page=100";
	private String projectBaseURL="http://10.66.2.254/api/v3/projects?private_token={auth_token}&per_page=100";
	private String commitsBaseURL="http://10.66.2.254/api/v3/projects/{projectId}/repository/commits?private_token={auth_token}&per_page=100";
	...
	private String listProjectMembersURLBase="http://10.66.2.254/api/v3/projects/{projectId}/members?private_token={auth_token}&per_page=100";
	private String commitWebURLBase="http://10.66.2.254/root/{project_name}/commit/{commit_id}&per_page=100";
	...
	protected void getCommits(ProfileBean profile, String userID) {
		...
		while (projects.hasNext()) {
			...
			String url = getURLWithAuthToken(commitsBaseURL).replaceAll("\\{projectId\\}", projectID);
	...
	protected void captureConnections(String userID, String annotation, String projectID, ProfileBean profile) {
		...
		String url = getURLWithAuthToken(listProjectMembersURLBase).replaceAll("\\{projectId\\}", projectID);
